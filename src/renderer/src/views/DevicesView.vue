...
.modern-table th { background: var(--surface-light); color: var(--text-sub); font-weight: normal; padding: 12px 16px; border-bottom: 1px solid var(--border); }
.modern-table td { padding: 12px 16px; border-bottom: 1px solid var(--border); color: var(--text-main); }
.modern-table tr:last-child td { border-bottom: none; }
.status-badge { padding: 2px 8px; border-radius: 10px; font-size: 11px; font-weight: bold; text-transform: uppercase; }
.status-badge.online { background: rgba(66, 185, 131, 0.2); color: var(--success); }
.status-badge.busy { background: rgba(230, 162, 60, 0.2); color: var(--warning); }
</style>